...
from curvedpy.utils.impact_plane.linalg import impact_vector_2 as impact_vector
...
def make_bg(width, height, a_texture, height_im, width_im, verbose=False, timing=True):
    ...
    aspectratio = 1
    # Camera position
    x_camera = np.array([0.0000001,0,30])#np.array([0,400,0])
    # Camera rotation
